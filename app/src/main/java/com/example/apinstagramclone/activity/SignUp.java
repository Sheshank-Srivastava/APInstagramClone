...
public class SignUp extends AppCompatActivity implements View.OnClickListener {
    private Button butSaveObject, butGetAllKB,butTransition;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        butTransition =  findViewById(R.id.butSwitchActivity);
        ...
        butTransition.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
